        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    {{-- <span class="brand-text">BALAJI JEWELLERS</span>  --}}
                </div>
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>&emsp;&emsp;&emsp;&emsp;&emsp;
                    ...
                    {{-- <x-nav-link :href="route('transactions.create')">
                        {{ __('Transaction') }}
                    </x-nav-link>&emsp; --}}
                    <!-- <x-nav-link :href="route('report.index')">
                        {{ __('Report') }}
                    </x-nav-link>&emsp;
                    <x-nav-link :href="route('report2.index')">
                        {{ __('Report2') }}
                    </x-nav-link>&emsp; -->
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        {{-- <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="url('amounts')">
                                    {{ __('Amount') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="url('find')">
                            {{ __('Fine Gold') }}
                        </x-dropdown-link>
                        </x-slot>
                        </x-dropdown> --}}
                        <!-- <x-nav-link :href="url('amounts')">
                            {{ __('Amount') }}
                        </x-nav-link>&emsp; -->
                        {{-- <x-nav-link :href="url('fine')">
                            {{ __('Fine') }}
                        </x-nav-link>&emsp; --}}
                        <!-- <x-nav-link :href="url('dhal/create')">
                            {{ __('Dhal') }} -->
                        </x-nav-link>&emsp;
                        {{-- <x-nav-link :href="url('dana')">
                            {{ __('Dana') }}
                        </x-nav-link>&emsp; --}}
                        <!-- <x-nav-link :href="url('chorsa')">
                            {{ __('Chorsa') }}
                        </x-nav-link>&emsp; -->
                    </div>
